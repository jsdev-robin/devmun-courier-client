                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <Heading as="h6">
                          {data?.data.parcel.customer.displayName}
                        </Heading>
                        ...
                        <div className="mt-2 space-y-1.5">
                          ...
                          <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                            ...
                            {data?.data.parcel.customer.phone}
                          </p>
                          <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                            <Mail className="size-4" />
                            {data?.data.parcel.customer.email}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="mt-2 space-y-1.5">
                          <p className="text-sm text-muted-foreground flex gap-1.5">
                            ...
                            <span>{data?.data.parcel.deliveryAddress}</span>
                          </p>
                          <p className="text-sm text-muted-foreground flex items-center gap-1.5">
                            <Phone className="size-4" />
                            {data?.data.parcel.receiverPhone}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <dl className="grid grid-cols-1 gap-x-4 gap-y-4">
                      ...
                      <div className="col-span-1">
                        ...
                        <dd className="mt-1 text-sm">
                          {data?.data.parcel.paymentMethod}
                        </dd>
                      </div>
                      <div className="col-span-1">
                        <dt className="text-sm font-medium text-muted-foreground">
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-4">
                            <Typography variant="sm" weight="medium">
                              {data?.data.parcel.agent.displayName}
                            </Typography>
                            <Typography variant="sm" textColor="muted">
                              Delivery Agent #
                              {data?.data.parcel.agent._id.slice(0, 5)}
                            </Typography>
                            <div className="mt-4 space-y-1.5">
                              <p className="text-sm flex items-center gap-1.5">
                                <Phone className="mr-2 size-4" />
                                {data?.data.parcel.agent.phone}
                              </p>
                            </div>
                          </div>
                        </div>
                        <Link
                          href={`tel:${data?.data.parcel.agent.phone}`}
