...
import { useGetCustomerByAdminQuery } from '../../../../../lib/features/services/adminControl/adminControllApi';
...
const AdminCustomerList = () => {
  ...
  const { data, isError, isLoading, isFetching } = useGetCustomerByAdminQuery({
    pagination,
    queryParams,
    sort,
    globalFilter,
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle translate="yes">Customer List</CardTitle>
      </CardHeader>
      <CardContent>
        <MunTable
          data={data?.data}
